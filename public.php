...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
      <img src="dist/img/masjid.jpg"
           ...
           style="opacity: .8">
      <span class="brand-text font-weight-light"> Masjid Besar Zainul Huda</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">CP : 08525585287</a>
        </div>
      </div>
  ...
  <footer class="main-footer">
    <div class="float-right d-none d-sm-block">
      Masjid Besar Zainul Huda
    </div>
    Copyright &copy;<a target="_blank" href="https://www.facebook.com/"><strong> Masjid Besar Zainul Huda</strong></a>
    All rights reserved.
  </footer>
