...
<head>
	...
	<title>Masjid Jami' Al-Barokah</title>
...
<body class="hold-transition sidebar-mini">
	...
	<div class="wrapper">
		...
		<nav class="main-header navbar navbar-expand navbar-default navbar-dark">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="http://localhost/MPI_KasMasjid/" class="nav-link">Home</a>
				</li>
				<li class="nav-item d-none d-sm-inline-block">
		...
		<aside class="main-sidebar sidebar-light-success elevation-4">
			<!-- Brand Logo -->
			<div class="nav badge-dark" >
			<a href="http://localhost/MPI_KasMasjid/" class="brand-link">
				<img src="dist/img/LogoMasjid.png" class="brand-image" style="opacity: .8">
				<span class="tools-text font-weight-dark"><b class="text-white" >Masjid Al-Barokah</b></span>
			</a>
		</div>
        ...
        ?>
						...
						<a href="http://localhost/MPI_KasMasjid/" class="nav-link">
          ...
          ?>
						...
						<li class="nav-item navbar-danger">
							<a onclick="return confirm('Apakah anda yakin akan keluar ?')" href="logout.php" class="nav-link">
								<i class="nav-icon fas fa-arrow-circle-left text-white"></i>
								<b class="text-white">
									Logout
								</b>
							</a>
    ...
    ?>
		...
		<footer class="main-footer">
			<div class="float-right d-none d-sm-block">
				Lestiani | Dede Yulyandri | Apriliani
			</div>
			Copyright &copy;
			<a target="_blank" href="https://www.facebook.com/">
				<strong> Masjid Jami' Al-Barokah</strong>
			</a>
			Teknik Informatika UNPAM(2022)
		</footer>
